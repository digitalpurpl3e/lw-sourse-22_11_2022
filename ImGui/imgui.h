...
namespace ui
{
    ...
    IMGUI_API bool          InputText(const char* label, wchar_t* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    void BeginTooltipExFixed(ImGuiWindowFlags extra_flags);
    void BeginTooltipFixed();
