...
// Render function.
// (this used to be set in io.RenderDrawListsFn and called by ui::Render(), but you can now call this directly from your main loop)
...
void ImGui_ImplDX9_InvalidateDeviceObjects()
{
	...
	// At this point note that we set ui::GetIO().Fonts->TexID to be == g_FontTexture, so clear both.
	ImGuiIO& io = ui::GetIO();
